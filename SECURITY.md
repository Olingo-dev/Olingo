...
We are committed to ensuring the security of our codebase. To maintain high security standards, we use CodeQL to automatically scan and analyze our code for potential vulnerabilities. This tool helps identify security flaws early in the development lifecycle, allowing us to address issues before they reach production.
...
1. Navigate to the [Issues](https://github.com/Olingo-dev/Olingo/issues) section of this repository.
2. Click on the "New Issue" button.
3. Select the "Security Vulnerability" template (if available).

#### Option 2: Email (For High-Risk Vulnerabilities)

If you believe the security vulnerability is exceptionally high-risk and should not be disclosed publicly, you can contact us via email at "security@olingo.dev". Please use this email address exclusively for reporting security vulnerabilities.
